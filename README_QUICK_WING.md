...
CORS_ORIGINS="*"
FRONTEND_URL="https://fleet-saas-1.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://fleet-saas-1.preview.emergentagent.com
```
...
**App URL**: https://fleet-saas-1.preview.emergentagent.com
