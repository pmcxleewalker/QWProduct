...
CORS_ORIGINS="*"
FRONTEND_URL="https://social-media-hub-77.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://social-media-hub-77.preview.emergentagent.com
```
...
**App URL**: https://social-media-hub-77.preview.emergentagent.com
