...
CORS_ORIGINS="*"
FRONTEND_URL="https://quickwing.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://quickwing.preview.emergentagent.com
```
...
**App URL**: https://quickwing.preview.emergentagent.com
