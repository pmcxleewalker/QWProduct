...
CORS_ORIGINS="*"
FRONTEND_URL="https://quickwing-saas.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://quickwing-saas.preview.emergentagent.com
```
...
**App URL**: https://quickwing-saas.preview.emergentagent.com
