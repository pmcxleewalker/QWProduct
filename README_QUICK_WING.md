...
CORS_ORIGINS="*"
FRONTEND_URL="https://multitenant-hub-3.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://multitenant-hub-3.preview.emergentagent.com
```
...
**App URL**: https://multitenant-hub-3.preview.emergentagent.com
