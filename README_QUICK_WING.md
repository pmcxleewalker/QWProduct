...
CORS_ORIGINS="*"
FRONTEND_URL="https://quickwing-fleet.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://quickwing-fleet.preview.emergentagent.com
```
...
**App URL**: https://quickwing-fleet.preview.emergentagent.com
