...
CORS_ORIGINS="*"
FRONTEND_URL="https://bluebird-fleet-mgmt.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://bluebird-fleet-mgmt.preview.emergentagent.com
```
...
**App URL**: https://bluebird-fleet-mgmt.preview.emergentagent.com
