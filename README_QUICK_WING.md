...
CORS_ORIGINS="*"
FRONTEND_URL="https://multi-tenant-fleet-1.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://multi-tenant-fleet-1.preview.emergentagent.com
```
...
**App URL**: https://multi-tenant-fleet-1.preview.emergentagent.com
