...
CORS_ORIGINS="*"
FRONTEND_URL="https://tenant-platform-11.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://tenant-platform-11.preview.emergentagent.com
```
...
**App URL**: https://tenant-platform-11.preview.emergentagent.com
