...
CORS_ORIGINS="*"
FRONTEND_URL="https://saas-fleet-mgmt.preview.emergentagent.com"
```

**Frontend (.env)**
```
REACT_APP_BACKEND_URL=https://saas-fleet-mgmt.preview.emergentagent.com
```
...
**App URL**: https://saas-fleet-mgmt.preview.emergentagent.com
