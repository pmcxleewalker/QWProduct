      ...
      <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-center">
        ...
        <div className="order-2 md:order-1 md:col-span-2">
          ...
          <h3
            ...
            className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-slate-900 mb-4"
          >
            {current.title}
          </h3>
          <p
          ...
          <div className="mt-7 flex items-center gap-3">
            ...
            <div className="flex-1 h-px bg-slate-200 max-w-[120px]">
              <div
        ...
        {/* Right: image inside a subtle "browser chrome" frame */}
      ...
      <div className="mt-10 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="h-11 w-11 rounded-full border border-slate-200 flex items-center justify-center text-slate-700 hover:bg-white transition-colors"
          >
            <ChevronLeft size={18} />
          </button>
          <button
            ...
            className="h-11 w-11 rounded-full bg-slate-900 flex items-center justify-center text-white hover:bg-slate-800 transition-colors shadow-md"
          >
