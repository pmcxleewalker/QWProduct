  ...
  return (
    <div className="max-w-7xl mx-auto px-3 py-4 sm:px-6 lg:px-8 pb-20 sm:pb-8">
      ...
      {showResetPasswordModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-bold mb-4">Reset Staff Password</h3>
            <p className="text-sm text-gray-600 mb-4">
              Reset password for: <span className="font-medium">{resetPasswordUser?.email}</span>
            </p>
            <form onSubmit={handleResetPassword} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Your Admin Password *</label>
                <input
                  type="password"
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Required to authorize the password change</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">New Password for Staff *</label>
                <input
                  type="password"
                  value={newPassword}
